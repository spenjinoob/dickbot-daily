import { p as Zt, N as Ii, s as ut, c as _, b as _e, L as Ne, d as Mt, a as Et, l as he, z as Fe, e as Pi } from "./vendors.js";
import { m as vi, X as T, H as B, n as w, V as U, v as ht, i as at, g as O, z as f, I as Oi, x as g, P as z, K as Ui, a as Bi, w as ie, y as N, b as C, c as _i, q as ki, u as Li, d as Me, e as We, l as Ri, C as q, Q as re, f as v, h as Ki, N as xi, Y as Di, j as Ci, k as ke, o as Ni, S as Le, T as Fi, p as Mi, A as Wi, E as Hi, r as He, s as L, t as se, _ as Vi } from "./btc-vision-bitcoin.js";
import { s as zi, m as qi, b as Xi } from "./noble-curves.js";
import { s as Jt, c as ee, e as $i, v as Yi } from "./noble-hashes.js";
const zt = Symbol;
...
class $ {
   ...
   */
  static compress(t) {
    return new Uint8Array(Re.gzipSync(t, $.zlibOptions));
  }
  /**
   ...
   */
  static decompress(t) {
    return new Uint8Array(Re.gunzipSync(t, $.zlibOptions));
  }
}
const W = Ii(), tr = W;
vi(tr);
const Ve = typeof _e == "function" ? _e : _.BIP32Factory;
if (!Ve)
  throw new Error("Failed to load BIP32 library");
const pt = zi.Point, er = pt.Fn.ORDER, ir = new Uint8Array([84, 97, 112, 84, 119, 101, 97, 107]), Ke = Jt(ir);
function rr(n) {
  return Jt($i(Ke, Ke, n));
}
class P {
  ...
  static fromPrivateKey(t, e = T.bitcoin) {
    return ut.fromPrivateKey(W, t, e);
  }
  /**
  ...
  static tweakPublicKey(t) {
    ...
    const e = typeof t == "string" ? t : g(t), i = pt.fromHex(e), r = (i.y & 1n) === 0n ? i : i.negate(), s = r.toBytes(!0).subarray(1), o = rr(s), a = qi(Xi(o), er);
  ...
  static generateQuantumKeyPair(t = _.MLDSASecurityLevel.LEVEL2, e = T.bitcoin) {
    const i = ee(64), r = _.QuantumBIP32Factory.fromSeed(i, e, t);
  ...
  static fromSeedKeyPair(t, e = T.bitcoin) {
    ...
    return ut.fromPrivateKey(W, r, e);
  }
}
var X = /* @__PURE__ */ ((n) => (n[n.ACCESS_LIST = 1] = "ACCESS_LIST", n[n.EPOCH_SUBMISSION = 2] = "EPOCH_SUBMISSION", n[n.MLDSA_LINK_PUBKEY = 4] = "MLDSA_LINK_PUBKEY", n))(X || {}), et = /* @__PURE__ */ ((n) => (n[n.ACCESS_LIST = 1] = "ACCESS_LIST", n[n.EPOCH_SUBMISSION = 2] = "EPOCH_SUBMISSION", n[n.MLDSA_LINK_PUBKEY = 3] = "MLDSA_LINK_PUBKEY", n))(et || {});
const D = 32, wt = 64, yt = 64, sr = 4, Bt = 32, vt = 16, qt = 8, mt = 4, Tt = 2, Xt = 1, nr = 32, Ot = 16, _t = 8, kt = 4, Lt = 2, Rt = 1, or = 1;
function ar(n, t, e, i) {
...
class Q {
  static isValidP2TRAddress(t, e) {
    ...
    let i = !1;
    try {
      z.toOutputScript(t, e), i = z.fromBech32(t).version === 1;
    } catch {
    }
    return i;
  }
  ...
  static isValidP2MRAddress(t, e) {
    ...
    let i = !1;
    try {
      z.toOutputScript(t, e);
      const r = z.fromBech32(t);
  ...
  static isP2WPKHAddress(t, e) {
    ...
    try {
      const r = z.fromBech32(t);
      z.toOutputScript(t, e), i = r.version === 0 && r.data.length === 20;
    } catch {
    }
    return i;
  }
...
class V {
   ...
   */
  static generateTimeLockAddress(t, e = T.bitcoin, i = V.CSV_BLOCKS) {
   ...
   */
  static generateTimeLockAddressP2MR(t, e = T.bitcoin, i = V.CSV_BLOCKS) {
    if (t.length !== 32)
  ...
  static generateTimeLockScript(t, e = V.CSV_BLOCKS) {
    return O.compile([
      O.number.encode(e),
...
class K extends Uint8Array {
  ...
  toCSV(t, e) {
    ...
    return V.generateTimeLockAddress(r, e, i);
  }
  /**
  ...
  toCSVTweaked(t, e) {
    ...
    if (this.ensureLegacyProcessed(), !this.#i)
      throw new Error("Cannot create CSV address: public key not set");
    return V.generateTimeLockAddressP2TR(
  ...
  toCSVP2MR(t, e) {
    ...
    return V.generateTimeLockAddressP2MR(
      this.tweakedPublicKeyToBuffer(),
      e,
      i
    );
  ...
  autoFormat(t) {
    ...
    this.#s = oe.generateHybridKeyFromHash(i), this.#o = new Uint8Array(D), this.#o.set(i);
  }
}
class At {
  _keys = [];
...
class Wt {
  ...
  static valueToUint8Array(t, e = Bt) {
    if (t < 0n)
...
class te {
  ...
  readI8() {
    ...
    return this.currentOffset += Rt, t;
  }
  /**
  ...
  readSchnorrSignature() {
    this.verifyEnd(
      this.currentOffset + wt + yt
    );
    const t = this.readExtendedAddress(), e = this.readBytes(yt);
...
class H {
  ...
  writeU32(t, e = !0) {
    ...
    this.allocSafe(mt), this.buffer.setUint32(this.currentOffset, t, !e), this.currentOffset += 4;
  }
  writeU64(t, e = !0) {
  ...
  writeI8(t) {
    ...
    this.allocSafe(Rt), this.buffer.setInt8(this.currentOffset, t), this.currentOffset += Rt;
  }
  /**
  ...
  writeI16(t, e = !0) {
    ...
    this.allocSafe(Lt), this.buffer.setInt16(this.currentOffset, t, !e), this.currentOffset += Lt;
  }
  /**
  ...
  writeI32(t, e = !0) {
    ...
    this.allocSafe(kt), this.buffer.setInt32(this.currentOffset, t, !e), this.currentOffset += kt;
  }
  /**
  ...
  writeI64(t, e = !0) {
    ...
    this.allocSafe(_t), this.buffer.setBigInt64(this.currentOffset, t, !e), this.currentOffset += _t;
  }
  // ---------------------------------------------------------------- //
  writeSelector(t) {
    this.writeU32(t, !0);
  ...
  writeI128(t, e = !0) {
    ...
    this.allocSafe(Ot);
    const i = Wt.valueToUint8Array(t, Ot);
    if (i.byteLength !== Ot)
  ...
  writeU128(t, e = !0) {
    ...
    this.allocSafe(vt);
    const i = Wt.valueToUint8Array(t, vt);
    if (i.byteLength !== vt)
  ...
  writeStringWithLength(t) {
    const i = new TextEncoder().encode(t);
    this.allocSafe(mt + i.length), this.writeU32(i.length), this.writeBytes(i);
  }
  /**
  ...
  writeExtendedAddress(t) {
    this.allocSafe(wt), this.writeTweakedPublicKey(t), this.writeBytes(t);
  }
  /**
  ...
  writeSchnorrSignature(t, e) {
    if (e.length !== yt)
      throw new Error(
        `Invalid Schnorr signature length: expected ${yt}, got ${e.length}`
      );
    this.allocSafe(wt + yt), this.writeExtendedAddress(t), this.writeBytes(e);
  }
  getBuffer(t = !0) {
  ...
  writeArrayOfBuffer(t, e = !0) {
    const i = H.estimateArrayOfBufferLength(t);
  ...
  writeExtendedAddressArray(t) {
    if (t.length > 65535) throw new Error("Array size is too large");
    this.allocSafe(Tt + t.length * wt), this.writeU16(t.length);
    for (let e = 0; e < t.length; e++)
...
class J {
  ...
  encodeFeature(t, e) {
    switch (t.opcode) {
      ...
      case X.EPOCH_SUBMISSION:
        return this.encodeChallengeSubmission(
          t,
          e
        );
      case X.MLDSA_LINK_PUBKEY:
...
const Ye = 0, Ge = Uint8Array.from([Ye]);
class pe extends J {
  constructor(t, e, i = T.bitcoin) {
    super(t, e, i);
  }
...
class nt {
  ...
  static getContractSeed(t, e, i) {
    const r = N.hash256(e), s = ht([t, i, r]);
    return N.hash256(s);
  }
  ...
  static buildScriptTree(t) {
    const e = t.network || T.bitcoin, r = new pe(
      t.deployerPubKey,
...
class pr {
  ...
  signMessage(t, e) {
    ...
    return {
      signature: W.signSchnorr(i, t.privateKey),
      message: i
    };
  }
  ...
  getOPWallet() {
    if (typeof window > "u")
      return null;
    const t = window;
    return !t.opnet || !Qe(t.opnet) ? null : t.opnet;
  }
}
const ct = new pr();
class rt {
...
var $t = /* @__PURE__ */ ((n) => (n[n.MINIMUM = 128] = "MINIMUM", n[n.LOW = 160] = "LOW", n[n.MEDIUM = 192] = "MEDIUM", n[n.HIGH = 224] = "HIGH", n[n.MAXIMUM = 256] = "MAXIMUM", n))($t || {}), Ut = /* @__PURE__ */ ((n) => (n[n.BIP44 = 44] = "BIP44", n[n.BIP49 = 49] = "BIP49", n[n.BIP84 = 84] = "BIP84", n[n.BIP86 = 86] = "BIP86", n))(Ut || {});
function fr(n) {
  switch (n) {
    case 44:
...
class Se {
  ...
  constructor(t, e = "", i = T.bitcoin, r = _.MLDSASecurityLevel.LEVEL2) {
    if (!Et.validateMnemonic(t))
      throw new Error("Invalid mnemonic phrase");
    this._phrase = t, this._passphrase = e, this._network = i, this._securityLevel = r, this._seed = Et.mnemonicToSeedSync(this._phrase, this._passphrase), this._classicalRoot = gr.fromSeed(this._seed, this._network), this._quantumRoot = _.QuantumBIP32Factory.fromSeed(
      this._seed,
      this._network,
      this._securityLevel
    );
  ...
  deriveMultiple(t, e = 0, i = 0, r = !1, s = Ut.BIP84) {
    const o = [];
    for (let a = 0; a < t; a++)
  ...
  buildClassicalPath(t, e, i, r = Ut.BIP84) {
...
var we = /* @__PURE__ */ ((n) => (n[n.Bitcoin = 0] = "Bitcoin", n[n.Fractal = 1] = "Fractal", n))(we || {});
function ye(n) {
  return n && !!(n.tapInternalKey || n.tapMerkleRoot || n.tapLeafScript && n.tapLeafScript.length || n.tapBip32Derivation && n.tapBip32Derivation.length || n.witnessUtxo && (Me(n.witnessUtxo.script) || We(n.witnessUtxo.script)));
}
function wr(n) {
...
var St = /* @__PURE__ */ ((n) => (n.Mainnet = "mainnet", n.Testnet = "testnet", n.OpnetTestnet = "opnetTestnet", n.Regtest = "regtest", n))(St || {}), Je = /* @__PURE__ */ ((n) => (n.BITCOIN_MAINNET = "BITCOIN_MAINNET", n.BITCOIN_TESTNET = "BITCOIN_TESTNET", n.BITCOIN_TESTNET4 = "BITCOIN_TESTNET4", n.BITCOIN_REGTEST = "BITCOIN_REGTEST", n.BITCOIN_SIGNET = "BITCOIN_SIGNET", n.OPNET_TESTNET = "OPNET_TESTNET", n.FRACTAL_BITCOIN_MAINNET = "FRACTAL_BITCOIN_MAINNET", n.FRACTAL_BITCOIN_TESTNET = "FRACTAL_BITCOIN_TESTNET", n.DOGECOIN_MAINNET = "DOGECOIN_MAINNET", n.DOGECOIN_TESTNET = "DOGECOIN_TESTNET", n.DOGECOIN_REGTEST = "DOGECOIN_REGTEST", n.LITECOIN_MAINNET = "LITECOIN_MAINNET", n.LITECOIN_TESTNET = "LITECOIN_TESTNET", n.LITECOIN_REGTEST = "LITECOIN_REGTEST", n.BITCOINCASH_MAINNET = "BITCOINCASH_MAINNET", n.BITCOINCASH_TESTNET = "BITCOINCASH_TESTNET", n.BITCOINCASH_REGTEST = "BITCOINCASH_REGTEST", n.DASH_MAINNET = "DASH_MAINNET", n.DASH_TESTNET = "DASH_TESTNET", n.DASH_REGTEST = "DASH_REGTEST", n))(Je || {}), ti = /* @__PURE__ */ ((n) => (n.ecdsa = "ecdsa", n.bip322 = "bip322-simple", n))(ti || {}), ei = /* @__PURE__ */ ((n) => (n.ecdsa = "ecdsa", n.schnorr = "schnorr", n))(ei || {});
class yr extends be {
  isInitialized = !1;
  constructor() {
    if (super(), !window)
  ...
  async init() {
    ...
    this._publicKey = he(w(e)), this._p2wpkh = P.getP2WPKHAddress(this, this.network), this._p2tr = P.getTaprootAddress(this, this.network), this._addresses = [this._p2wpkh, this._p2tr], this.isInitialized = !0;
  }
  getPublicKey() {
    if (!this.isInitialized)
  ...
  async multiSignPsbt(t) {
    ...
    for (const o of t) {
      ...
      const c = o.data.inputs.map((u, l) => {
        ...
        } else me(u, this.publicKey) && (h = !0, d = !1);
        return h ? {
          index: l,
...
function br(n) {
  return {
    enabled: !0,
    signerMap: n instanceof Map ? n : ii(n)
  };
}
function Ar() {
  return {
...
var si = /* @__PURE__ */ ((n) => (n[n.REPLACE_BY_FEE = 4294967293] = "REPLACE_BY_FEE", n[n.FINAL = 4294967295] = "FINAL", n))(si || {}), ni = /* @__PURE__ */ ((n) => (n[n.BLOCKS = 0] = "BLOCKS", n[n.TIMESTAMPS = 1] = "TIMESTAMPS", n))(ni || {});
class Dt extends Ne {
  logColor = "#00ffe1";
  finalized = !1;
  /**
  ...
  async signKeyPathInputsParallel(t, e) {
    ...
    const s = ri(i, r), o = Ki(t, s), a = e ? o.filter((l) => !e.has(l.inputIndex)) : o;
    if (a.length === 0)
      return {
        success: !0,
  ...
  generateP2SHRedeemScriptLegacy(t) {
    ...
    if (z.fromOutputScript(s, this.network) === t && a.redeem && a.redeem.output)
      return {
        redeemScript: i,
  ...
  generatePsbtInputExtended(t, e, i = !1) {
    ...
    if (Ci(r))
      ...
      t.nonWitnessUtxo && (s.nonWitnessUtxo = t.nonWitnessUtxo instanceof Uint8Array ? t.nonWitnessUtxo : w(t.nonWitnessUtxo)), ke(c) ? Reflect.deleteProperty(s, "nonWitnessUtxo") : Le(c) ? (Reflect.deleteProperty(s, "nonWitnessUtxo"), this.processP2WSHInput(t, s, e)) : Reflect.deleteProperty(s, "witnessUtxo");
    } else if (Me(r)) {
      if (this.sighashTypes) {
        const o = Dt.calculateSignHash(this.sighashTypes);
        o && (s.sighashType = o);
      }
...
class E extends Dt {
  ...
  addOutput(t, e = !1) {
    if (t.value === L(0n)) {
      ...
      if (i.script[0] !== f.OP_RETURN && !C(i.script, ue))
        throw new Error(
  ...
  async estimateTransactionFees() {
    ...
    const t = new q({ network: this.network }), e = this.getInputs(), i = this.getOutputs();
    ...
    const r = new Uint8Array(64), s = new Uint8Array(72), o = new Uint8Array(33).fill(2), a = (d, p) => {
      ...
      if (d === 0 && this.tapLeafScript) {
        const m = new Uint8Array(32), A = this.tapLeafScript.script, x = this.useP2MR ? 33 : 65, Y = new Uint8Array(x);
        return {
          finalScriptWitness: E.witnessStackToScriptWitness([
            m,
            r,
  ...
  async rebuildFromBase64(t) {
    return this.transaction = q.fromBase64(t, {
      network: this.network,
      version: this.txVersion
  ...
  generateLegacySignature() {
    ...
    r.writeU8(_.MLDSASecurityLevel.LEVEL2), r.writeBytes(this.hashedPublicKey), r.writeBytes(t), r.writeBytes(e), r.writeBytes(Ce), r.writeBytes(i);
  ...
  addFeeToOutput(t, e, i, r) {
    if (r) {
      let s;
      t > j + Pt ? s = Pt : s = t, this.addOutput(
        {
          value: L(s),
          address: e
        },
        !0
      ), s === Pt && t - Pt > j && this.addOutput(
        {
          value: L(t - s),
          address: i.address
        },
...
class Yt extends E {
  ...
  constructor(t) {
    ...
    this.witnesses = t.witnesses, this.randomBytes = t.randomBytes || M.rndBytes(), this.LOCK_LEAF_SCRIPT = this.defineLockScript(), this.scriptSeed = this.getContractSeed(), this.contractSigner = P.fromSeedKeyPair(this.scriptSeed, this.network), this.generator = new $e(this.internalPubKeyToXOnly(), this.network), this.compiledTargetScript = this.generator.compile(t.script), this.scriptTree = this.getScriptTree(), this.internalInit(), this._scriptAddress = fe.generatePKSH(this.scriptSeed, this.network);
  }
  /**
...
class Ae extends E {
  ...
  constructor(t) {
    ...
    this.challenge = t.challenge, this.LOCK_LEAF_SCRIPT = this.defineLockScript(), this.disableAutoRefund = t.disableAutoRefund || !1, this.epochChallenge = V.generateTimeLockAddress(
  ...
  async signInputsNonWalletBased(t) {
    if (await this.signInput(
      ...
      0,
      this.getSignerKey()
    ), t.finalizeInput(0, this.customFinalizer.bind(this)), this.canUseParallelSigning && dt(this.signer)) {
      let e = /* @__PURE__ */ new Set();
      try {
        const i = await this.signKeyPathInputsParallel(t, /* @__PURE__ */ new Set([0]));
        i.success && (e = new Set(i.signatures.keys()));
...
class bt extends E {
  ...
  constructor(t) {
    ...
    if (this.randomBytes = t.randomBytes || M.rndBytes(), this.challenge = t.challenge, this.LOCK_LEAF_SCRIPT = this.defineLockScript(), this.epochChallenge = V.generateTimeLockAddress(
      this.challenge.publicKey.originalPublicKeyBuffer(),
      this.network
  ...
  getContractSeed() {
    ...
    const t = this.internalPubKeyToXOnly(), e = N.hash256(this.randomBytes), i = N.hash256(this.bytecode), r = ht([t, e, i]);
    return N.hash256(r);
  }
  /**
   * Finalize the transaction
...
class it extends E {
  ...
  constructor(t) {
    ...
    if (!t.challenge)
      throw new Error("Challenge solution is required");
    if (this.disableAutoRefund = t.disableAutoRefund || !1, this.contractSecret = w(t.contract.startsWith("0x") ? t.contract.slice(2) : t.contract), this.calldata = $.compress(t.calldata), this.challenge = t.challenge, this.randomBytes = t.randomBytes || M.rndBytes(), this.scriptSigner = this.generateKeyPairFromSeed(), this.p2wdaGenerator = new xt(
      this.signer.publicKey,
      this.scriptSignerXOnlyPubKey(),
      this.network
    ), this.contractSecret.length !== 32)
      throw new Error("Invalid contract secret length. Expected 32 bytes.");
    if (this.epochChallenge = V.generateTimeLockAddress(
      this.challenge.publicKey.originalPublicKeyBuffer(),
      this.network
  ...
  finalizePrimaryP2WDA(t, e) {
    ...
    if (!this.compiledOperationData)
      throw new Error("Operation data not compiled");
    const i = e.partialSig[0].signature, r = ht([i, this.compiledOperationData]), o = ct.signMessage(
      this.signer,
      r
...
class oi extends E {
  ...
  constructor(t) {
    ...
    if (this.contractAddress = t.to, this.contractSecret = w(t.contract.startsWith("0x") ? t.contract.slice(2) : t.contract), this.disableAutoRefund = t.disableAutoRefund || !1, this.maxChunkSize = t.maxChunkSize ?? I.MAX_CHUNK_SIZE, this.contractSecret.length !== 32)
      throw new Error("Invalid contract secret length. Expected 32 bytes.");
    if (this.calldata = $.compress(t.calldata), this.randomBytes = t.randomBytes || M.rndBytes(), this.scriptSigner = P.fromSeedKeyPair(this.randomBytes, this.network), this.challenge = t.challenge, this.epochChallenge = V.generateTimeLockAddress(
      this.challenge.publicKey.originalPublicKeyBuffer(),
      this.network
  ...
  buildRevealTransaction(t) {
    const e = new q({ network: this.network }), i = this.calculateValuePerOutput();
...
class ai {
  ...
  async createCancellableTransaction(t) {
    ...
    const r = await new Ee(t).signTransaction();
    return {
      transaction: r.toHex(),
  ...
  async signInteraction(t) {
    ...
    const r = this.parseOptionalInputs(t.optionalInputs), { finalTransaction: s, estimatedAmount: o, challenge: a } = await this.iterateFundingAmount(
      ...
      Qt,
      async (m) => {
        const A = await m.estimateTransactionFees(), x = m.getTotalOutputValue();
        return A + x;
      },
      "Interaction"
    );
  ...
  async signConsolidatedInteraction(t) {
    ...
    const e = this.parseOptionalInputs(t.optionalInputs), i = new oi({
      ...t,
      optionalInputs: e
    }), r = await i.build();
    return {
  ...
  async signDeployment(t) {
    ...
    const i = this.parseOptionalInputs(t.optionalInputs), { finalTransaction: r, estimatedAmount: s, challenge: o } = await this.iterateFundingAmount(
      ...
      bt,
      async (Y) => {
        const Nt = await Y.estimateTransactionFees(), Ft = this.getPriorityFee(t), Ei = Y.getOptionalOutputValue();
        return Nt + Ft + Ei;
      },
      "Deployment"
    );
    ...
    const h = l.outs[0], d = {
      ...
      optionalInputs: i
    }, y = new bt(p), m = await y.signTransaction(), A = l.outs[1], x = {
      transactionId: l.getId(),
      outputIndex: 1,
      scriptPubKey: {
        hex: g(A.script),
...
class R extends E {
   ...
   */
  static fromBase64(t) {
    const e = q.fromBase64(t.psbt, { network: t.network });
    return new R({
      ...t,
      psbt: e
    });
...
var Ct = /* @__PURE__ */ ((n) => (n[n.Roswell = 0] = "Roswell", n[n.Rachel = 1] = "Rachel", n[n.Kecksburg = 2] = "Kecksburg", n[n.Phoenix = 3] = "Phoenix", n[n.Aurora = 4] = "Aurora", n[n.Rendlesham = 5] = "Rendlesham", n[n.Lazar = 6] = "Lazar", n[n.ShagHarbor = 7] = "ShagHarbor", n[n.Exeter = 8] = "Exeter", n[n.Stephenville = 9] = "Stephenville", n[n.Valensole = 10] = "Valensole", n[n.Socorro = 11] = "Socorro", n[n.Pascagoula = 12] = "Pascagoula", n[n.Tehran = 13] = "Tehran", n[n.Westall = 14] = "Westall", n[n.Hopkinsville = 15] = "Hopkinsville", n[n.Belgium = 16] = "Belgium", n[n.Breeze = 17] = "Breeze", n[n.Flatwoods = 18] = "Flatwoods", n[n.Maury = 20] = "Maury", n[n.Varginha = 21] = "Varginha", n[n.Trindade = 22] = "Trindade", n[n.Levelland = 23] = "Levelland", n[n.Wanaque = 24] = "Wanaque", n[n.Coyame = 25] = "Coyame", n[n.Delphos = 26] = "Delphos", n))(Ct || {});
const pi = {
  CONSENSUS: Ct.Roswell,
  CONSENSUS_NAME: "Roswell",
  // The block height at which this consensus was enabled.
  ENABLED_AT_BLOCK: 0n
}, fi = {
  [Ct.Roswell]: pi
}, Pe = Ct.Roswell, Pr = fi[Pe];
class tt {
  /**
...
class le {
  ...
  submission;
  constructor(t) {
    this.epochNumber = BigInt(t.epochNumber), this.publicKey = K.fromString(t.mldsaPublicKey, t.legacyPublicKey), this.solution = F(t.solution), this.salt = F(t.salt), this.graffiti = F(t.graffiti), this.difficulty = t.difficulty, this.verification = new gi(t.verification), this.submission = t.submission ? new Si(t.submission, this.epochNumber + 2n) : t.submission;
  }
  /**
...
class vr {
  ...
  static async multiSigAddSignature(t, e) {
    ...
    r.existingPsbtBase64 ? o = q.fromBase64(r.existingPsbtBase64, { network: a }) : o = await this.importForSigning(t, {
      signer: e
    }).signPSBT();
    const c = [];
  ...
  static multiSigHasSigned(t, e) {
    ...
    if (!r.existingPsbtBase64)
      return !1;
    const s = gt.nameToNetwork(i.baseParams.networkName), o = q.fromBase64(r.existingPsbtBase64, { network: s }), a = e instanceof Uint8Array ? e : w(e);
  ...
  static multiSigGetSignatureStatus(t) {
    ...
    const s = gt.nameToNetwork(e.baseParams.networkName), o = q.fromBase64(i.existingPsbtBase64, { network: s }), a = /* @__PURE__ */ new Set();
  ...
  static multiSigFinalize(t) {
    ...
    const r = gt.nameToNetwork(e.baseParams.networkName), s = q.fromBase64(i.existingPsbtBase64, { network: r }), o = i.pubkeys.map((u) => w(u)), a = [];
...
class Or {
  ...
  async fetchUTXO(t) {
    ...
    for (const y of u) {
      ...
      let Y = p.get(A);
      if (Y === void 0 && (Y = Vi(x), p.set(A, Y)), h += m, l.push({
  ...
  async splitUTXOs(t, e, i, r) {
    ...
    const c = {
      ...
      gasSatFee: 330n,
      mldsaSigner: null
    }, l = await new ai().createBTCTransfer(c), h = await this.broadcastTransaction(l.tx, !1);
...
var wi = /* @__PURE__ */ ((n) => (n[n.UNWRAP = 0] = "UNWRAP", n))(wi || {});
class Ur {
  /**
   * Generate a multi-sig address
   * @param {Uint8Array[]} pubKeys - The public keys to use
...
class Rr extends be {
  ...
  async init() {
    ...
    this._network = i, this._publicKey = he(w(e.publicKey)), this._p2wpkh = P.getP2WPKHAddress(this, this.network), this._p2tr = P.getTaprootAddress(this, this.network), this._addresses = [this._p2wpkh, this._p2tr], this.isInitialized = !0;
  }
  ...
  async multiSignPsbt(t) {
    ...
    for (const a of t) {
      ...
      const u = a.data.inputs.map((l, h) => {
        ...
        } else me(l, this.publicKey) && (d = !0, p = !1);
        return d ? {
          index: h,
          publicKey: g(this.publicKey),
    ...
    const o = q.fromBase64(s.result.psbt);
    t[0].combine(o);
  }
  hasAlreadySignedTapScriptSig(t) {
    for (let e = 0; e < t.length; e++) {
  ...
  async signAllTweaked(t, e, i = !1) {
    ...
    return q.fromBase64(u.result.psbt);
  }
  getNonDuplicateScriptSig(t, e) {
    const i = [];
    for (let r = 0; r < e.length; r++) {
...
const Nr = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  ChallengeVerification: gi,
  Compressor: $,
  Consensus: Ct,
  ConsolidatedInteractionTransaction: oi,
  ContractAddress: oe,
  ...
  DeterministicMap: Ue,
  DeterministicSet: Be,
  EXTENDED_ADDRESS_BYTE_LENGTH: wt,
  EcKeyPair: P,
  EpochValidator: ft,
  ExtendedAddressMap: Xe,
  FastMap: At,
  FeaturePriority: et,
  Features: X,
  ...
  NetEvent: Lr,
  OPNET_DEPLOYMENT_VERSION: Ye,
  OPNetConsensusConfig: fi,
  ...
  isAbiStruct: ve,
  isAbiTuple: mi,
  isCancelSpecificData: di,
  isCustomScriptSpecificData: hi,
  isDeploymentSpecificData: ui,
  isFundingSpecificData: ci,
  isInteractionSpecificData: li,
  isMultiSigSpecificData: ot,
  isOPWallet: Qe,
  isSimpleAbiType: Ti,
  isUniversalSigner: dt,
  toParallelKeyPair: Er,
  toTweakedParallelKeyPair: ri,
  version: Gi,
  versionBuffer: Ge
...
export {
  ...
  Ee as CancelTransaction,
  we as ChainId,
  le as ChallengeSolution,
  Si as ChallengeSubmission,
  gi as ChallengeVerification,
  $ as Compressor,
  Ct as Consensus,
  oi as ConsolidatedInteractionTransaction,
  ...
  wt as EXTENDED_ADDRESS_BYTE_LENGTH,
  P as EcKeyPair,
  ft as EpochValidator,
  Xe as ExtendedAddressMap,
  At as FastMap,
  ...
  Ot as I128_BYTE_LENGTH,
  Lt as I16_BYTE_LENGTH,
  nr as I256_BYTE_LENGTH,
  kt as I32_BYTE_LENGTH,
  _t as I64_BYTE_LENGTH,
  Rt as I8_BYTE_LENGTH,
  Qt as InteractionTransaction,
  it as InteractionTransactionP2WDA,
  dr as LegacyCalldataGenerator,
  Pt as MINIMUM_AMOUNT_CA,
  ...
  Lr as NetEvent,
  Ye as OPNET_DEPLOYMENT_VERSION,
  fi as OPNetConsensusConfig,
  ...
  ve as isAbiStruct,
  mi as isAbiTuple,
  di as isCancelSpecificData,
  hi as isCustomScriptSpecificData,
  ui as isDeploymentSpecificData,
  ci as isFundingSpecificData,
  li as isInteractionSpecificData,
  ot as isMultiSigSpecificData,
  Qe as isOPWallet,
  Ti as isSimpleAbiType,
  dt as isUniversalSigner,
  Nr as opnet,
  Er as toParallelKeyPair,
  ri as toTweakedParallelKeyPair,
  Gi as version,
  Ge as versionBuffer
};

import { fromBase64, fromHex, networks, toHex, } from '@btc-vision/bitcoin';
import { Address, BinaryReader, ChallengeSolution, NetEvent, TransactionFactory, } from '@btc-vision/transaction';
...
export class CallResult {
    ...
    async signTransaction(interactionParams, amountAddition = 0n) {
        ...
        if (this.constant) {
            throw new Error('Cannot send a transaction on a constant (view) function. Use the returned CallResult directly.');
        }
        if (this.payable) {
            ...
            if (!hasExtraInputs && !hasExtraOutputs) {
                throw new Error('Payable function requires extraInputs or extraOutputs in the transaction parameters.');
            }
        }
    ...
    #getNetworkName() {
        ...
        if (network === networks.opnetTestnet)
